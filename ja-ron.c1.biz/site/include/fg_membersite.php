...
class FGMembersite
{
    ...
    {
        return 'sp'.md5('0iQx5oBk66oVZep'.$this->rand_key);
    }
    ...
    {
        $this->HandleError($err."\r\n mysqlierror:".mysqli_error($this->connection));//, $err)); 
    }
    ...
    function GetUserFromEmail($email,&$user_rec)
    {
        ...
        //$result = mysqli_query("SELECT * FROM `Users`",$this->connection);
    ...
    function DBLogin()
    {
        ...
        //$this->connection = mysqli_connect("fdb31.biz.nf","4004725_jaron","6Zc@zChv3erdgL@");
        ...
        //if(!mysqli_select_db('Users', $this->connection))
        {
            //$this->HandleDBError('Failed to select database: Users Please make sure that the database name provided is correct');
    ...
    {
        $result = mysqli_query($this->connection, "SHOW COLUMNS FROM Users");   
        if(!$result || mysqli_num_rows($result) <= 0)
        {
